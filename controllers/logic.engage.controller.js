...
module.exports.logicCustomerData = async (customerVersion, mobile, storeId) => {
  try {
    ...
    const record = await linkModel.readMerchantStoreCustomer(
      "customer_information_data.customer_information_id AS cust_identity_id, customer_information_data.first_name, customer_information_data.last_name, customer_information_data.email, customer_information_data.mobile, customer_information_data.dob, customer_information_data.married, customer_information_data.spouse_name, customer_information_data.anniversary_date, customer_information_data.address_one, customer_information_data.address_two, customer_information_data.landmark, customer_information_data.gender_id, customer_information_data.city_id AS city_unique, customer_information_data.locality_id AS locality_unique, cities.city_name, localities.locality_name, genders.name AS gender_name, membership_cards.membership_card_number AS membership_card",
      merchantRecord[0].partner_id,
      storeId,
      1
    );
