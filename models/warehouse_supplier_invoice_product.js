...
module.exports = (sequelize, DataTypes) => {
  const warehouseSupplierInvoiceProduct = sequelize.define(
    "warehouse_supplier_invoice_product",
    {
  ...
  warehouseSupplierInvoiceProduct.associate = function(models) {
    // associations can be defined here
  };
  return warehouseSupplierInvoiceProduct;
};
